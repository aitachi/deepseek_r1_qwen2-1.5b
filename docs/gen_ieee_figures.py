...
def save_dual(fig, name, dpi=300, facecolor=None):
...
def fig1_convergence_comparison():
    ...
    ax.set_ylim(0, 3.0)
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig1_convergence')
    plt.close()
...
def fig2_reward_curves():
    ...
    ax.set_xlim(0, 200)
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig2_reward')
    plt.close()
...
def fig3_entropy_length():
    ...
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig3_entropy_length')
    plt.close()
...
def fig4_clip_higher_visualization():
    ...
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig4_clip_higher')
    plt.close()
...
def fig5_token_vs_sample_level():
    ...
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig5_token_sample')
    plt.close()
...
def fig6_overlong_shaping():
    ...
    ax.set_ylim(-1.2, 0.3)
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig6_overlong')
    plt.close()
...
def fig7_radar_comparison():
    ...
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig7_radar')
    plt.close()
...
def fig8_3d_surface():
    ...
    plt.close()
    print('[OK] ieee_fig8_3d_surface.png (PNG only - 3D)')
...
def fig9_ablation():
    ...
    ax.set_ylim(0, 58)
    plt.tight_layout()
    save_dual(plt.gcf(), 'ieee_fig9_ablation')
    plt.close()
