...
def ppo_flow():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/ppo_flowchart.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] ppo_flowchart.png')
...
def dpo_flow():
    ...
    ax.text(9.2,12,'Repeat\n循环',ha='center',fontsize=10,color='#7f8c8d',fontstyle='italic')
    plt.tight_layout(); plt.savefig(f'{OUT}/dpo_flowchart.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] dpo_flowchart.png')
...
def grpo_flow():
    ...
    ax.text(9.2,12,'Repeat\n循环',ha='center',fontsize=10,color='#7f8c8d',fontstyle='italic')
    plt.tight_layout(); plt.savefig(f'{OUT}/grpo_flowchart.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] grpo_flowchart.png')
...
def dapo_flow():
    ...
    ax.text(9.2,12,'Repeat\n循环',ha='center',fontsize=10,color='#7f8c8d',fontstyle='italic')
    plt.tight_layout(); plt.savefig(f'{OUT}/dapo_flowchart.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] dapo_flowchart.png')
...
def data_flow(name, fn, boxes):
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/{fn}',dpi=200,bbox_inches='tight'); plt.close(); print(f'[OK] {fn}')
...
def loss_2d():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/comparison_loss_curves_2d.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] comparison_loss_curves_2d.png')
...
def reward_2d():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/comparison_reward_curves_2d.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] comparison_reward_curves_2d.png')
...
def radar():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/comparison_radar_chart.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] comparison_radar_chart.png')
...
def bar_2d():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/comparison_bar_chart_2d.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] comparison_bar_chart_2d.png')
...
def surface_3d():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/comparison_3d_surface.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] comparison_3d_surface.png')
...
def tradeoff_3d():
    ...
    plt.tight_layout(); plt.savefig(f'{OUT}/comparison_3d_tradeoff.png',dpi=200,bbox_inches='tight'); plt.close(); print('[OK] comparison_3d_tradeoff.png')
