...
def ppo_flowchart():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/ppo_flowchart.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] ppo_flowchart.png')
...
def dpo_flowchart():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/dpo_flowchart.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] dpo_flowchart.png')
...
def grpo_flowchart():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/grpo_flowchart.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] grpo_flowchart.png')
...
def dapo_flowchart():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/dapo_flowchart.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] dapo_flowchart.png')
