...
def algorithm_timeline():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/algorithm_timeline.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] algorithm_timeline.png')
...
def algorithm_taxonomy():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/algorithm_taxonomy.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] algorithm_taxonomy.png')
...
def resource_heatmap():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/resource_heatmap.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] resource_heatmap.png')
...
def loss_function_comparison():
    ...
    fig.suptitle('Loss Function Comparison: PPO vs DPO vs GRPO vs DAPO\n'
                 ...
                 color='#2c3e50', y=1.02)
    plt.tight_layout()
    plt.savefig(f'{OUT}/loss_function_comparison.png', dpi=180,
                bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] loss_function_comparison.png')
...
def convergence_comparison_4():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/convergence_4algo.png', dpi=180,
                bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] convergence_4algo.png')
...
def performance_radar_detailed():
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/radar_8dim.png', dpi=180, bbox_inches='tight', facecolor=BG)
    plt.close()
    print('[OK] radar_8dim.png')
